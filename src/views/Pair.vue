<template>
  <v-card :title="`Network: ${networkName} (${networkId})`" :subtitle="`Pair contract: ${pairSelect} (${pairId})`" class="mb-8"></v-card>
  <v-row>
    ...
    <v-col cols="12" md="auto">
      <v-select hide-details label="Span" variant="outlined"
        v-model="span"
        :items="spans"
      />
    </v-col>
