...
export default {
  ...
  computed: {
    ...
    buyVolume24() { return this.pairInfo ? Math.round(this.pairInfo.pull.buy_volume_24h) : 0 },
    sellVolume24() { return this.pairInfo ? Math.round(this.pairInfo.pull.sell_volume_24h) : 0 },
    // buyTxCount24() { return this.pairInfo ? this.pairInfo.pull.buy_tx_count_24h : 0 },
    // sellTxCount24() { return this.pairInfo ? this.pairInfo.pull.sell_tx_count_24h : 0 },
