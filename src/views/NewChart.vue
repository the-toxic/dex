...
export default {
  ...
  computed: {
    ...
    buyVolume24() { return this.pairInfo ? Math.round(this.pairInfo.token1.day_buy_volume) : 0 },
    sellVolume24() { return this.pairInfo ? Math.round(this.pairInfo.token1.day_sell_volume) : 0 },
